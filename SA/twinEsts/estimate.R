...
# Load data
pheno = read_table("/panfs/jay/groups/31/rando149/coffm049/Temppheno.csv") %>%
...
saveRDS(df, "/panfs/jay/groups/31/rando149/coffm049/ABCD/Workflow/03_Herit_ests/Topography/SA/twinEsts/herit_w_total.Rds")
